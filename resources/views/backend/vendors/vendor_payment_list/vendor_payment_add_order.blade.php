                                    ...
                                    <div class="card-text">                                        
                                        <div class="card-text">
                                            @if (isset($id))
                                                ...
                                                @endforeach --}}
                                                @php
                                                    $total_amount = $order->vendor_amount;
                                                    $pending_amount = $order->vendor_pending_payment;
                                                @endphp
                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="pull-right">
                                                    ...
                                                    <a href="{{URL::'/webadmin/vendor_payment_list'}}" class="btn btn-danger px-3 py-1"></i>Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
